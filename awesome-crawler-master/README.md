...
* [mechanize](https://github.com/python-mechanize/mechanize) -Easy HTML form filling.Convenient link parsing and following in browser.
* [Twill](https://github.com/ctb/twill) -is a simple scripting language built on top of Mechanize
* [BeautifulSoup + urllib2](https://github.com/akalongman/python-beautifulsoup) -also works quite nicely.
* [HarvestMan](https://github.com/mion/harvestman) -  a multi-threaded web-crawler written in Python, also give a look to the spider.py module.
* [Ruya]()- crawler for crawling English, Japanese websites. It is targeted solely   towards developers who want crawling functionality in their code.
